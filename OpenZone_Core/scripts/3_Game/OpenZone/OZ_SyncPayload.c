...
{
    // ПОЛЯ Schema ТУТ БІЛЬШЕ НЕМАЄ: сервер його писав, клієнт не читав
    // жодного разу, а звірка схеми на OZ_Hello не могла спрацювати в
    // принципі -- обидва кінці крутять один pbo.
