...
class OZ_Spawns
{
    ...
    //
    // САМЕ Info, А НЕ Dbg (ТЗ-5 R-A4.1). «Завжди» вище було неправдою: на
    // бойовому сервері DebugMode вимкнений, і рядок мовчав рівно там, де
    // чотири режими відмови нерозрізненні. Один рядок на появу -- ціна, яку
    // лог витримає; ступінь драбини в ньому вже названа (R-A4.2).
